  ...
  return (
    <nav className="topbar">
      ...
      <div className="nav-links">
        ...
        <a onClick={() => onNav('recs')} className={active === 'recs' ? 'active' : ''} style={{ cursor: 'pointer' }}>Recommendations</a>
        <a>Leaderboards</a>
...
function ScreenSwitcher({ active, onNav }) {
  return (
    <div className="screen-switcher">
      ...
      <button className={active === 'analysis' ? 'active' : ''} onClick={() => onNav('analysis')}>2 · Analysis</button>
      <button className={active === 'recs' ? 'active' : ''} onClick={() => onNav('recs')}>3 · Recs</button>
    </div>
  );
}
  ...
  return (
    <>
      <div className="shell" data-screen-label={
        ...
        screen === 'analysis' ? '02 Analysis' : '03 Recommendations'
      }>
