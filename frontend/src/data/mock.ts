import type { GlobalMeta, Realm, RecentChar, CharProfile, StatGap, SlotItem, RaidBoss, Dungeon } from './types';
...
export const RECENT: RecentChar[] = [
...
export const SECONDARY = { stamina: 612400, intellect: 38420 };
