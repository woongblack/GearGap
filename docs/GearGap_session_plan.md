# GearGap MVP — 남은 세션 계획

> 현재 진행도: 45% 완료 (Phase 0 + MurlokScraper + 코드베이스 정리 + BiS DB 적재)
> 남은 작업을 8개 세션으로 분할.
> 각 세션 = 2~4시간 작업 분량.
...
## 세션 3 — Raidbots Ingestion + 도메인 모델 매핑
...
```
세션 1 (완료): Phase 0 + MurlokScraper + 청소        [████████░░░░░░░░░░░░░░░░░░░░] 35%
세션 2 (완료): BiS DB 적재                           [██████████░░░░░░░░░░░░░░░░░░] 45%
